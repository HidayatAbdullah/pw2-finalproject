                        ...
                        <div class="p-6.5">
                            ...
                            <div class="mb-4.5">
                                ...
                                <input
                                    ...
                                    placeholder="Enter cost Rp.***"
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter"
                                />
                            </div>

                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Year Release <span class="text-meta-1">*</span> </label>
                                <input
                                    id="year"
                                    name="year"
                                    type="text"
                            ...
                            <div class="mb-4.5">
                                ...
                                <input
                                    ...
                                    placeholder="Enter License Plate Ex:B123EZR "
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter"
                                />
                            </div>
